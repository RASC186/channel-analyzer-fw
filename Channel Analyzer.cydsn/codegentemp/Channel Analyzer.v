// ======================================================================
// Channel Analyzer.v generated from TopDesign.cysch
// 08/19/2023 at 21:35
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=100, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=199, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=ANALIZER_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ANALIZER_PWM, CY_INSTANCE_SHORT_NAME=ANALIZER_PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ANALIZER_PWM, )
...
// VDAC12_PDL_v2_0(DacCodeMode=0, DebugEnable=false, DeepSleep=false, DwrExtAfterCustomized=false, DwrRefExternal=0, GainBandwidth=2, InitialCode=0, InitialVoltage_mV=0, OpampIDD=2, OpAmpUsage=0, OutputBuffer=0, OutputBufferPower=2, OutputBufferRange=0, RefBufferRange=0, ReferenceCurrentHigh=true, SampleAndHold=false, ShowClk=true, ShowStrobe=false, ShowTrig=true, UpdateMode=1, VrefSource=1, VrefVoltage=1.2, VrefVoltage_mV=3300, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC12_PDL_v2_0, CY_CONFIG_TITLE=ANALYZER_VDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ANALYZER_VDAC, CY_INSTANCE_SHORT_NAME=ANALYZER_VDAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctdac, CY_PDL_DRIVER_REQ_VERSION=2.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ANALYZER_VDAC, )
...
module DMA_PDL_v2_0_4 (
    ...
    cy_mxs40_dw_v1_0 DW (
        ...
        .tr_in(tr_in),
        .tr_out(tr_out));
    defparam DW.priority = 1;



endmodule

// SCB_UART_PDL_v2_0(BaudRate=115200, BitsOrder=0, BreakSignalBits=11, BufferMinSize=64, ByteMode=true, ClkFreqDes=1152, ClkMinusTolerance=5, ClkPlusTolerance=5, ClockFromTerm=true, ComMode=0, CtsPolarity=0, CtsTermEnable=false, DataWidth=8, Direction=3, DropOnFrameErr=false, DropOnParityErr=false, EnableCts=false, EnableInputFilter=false, EnableMultiProc=false, EnableRts=false, EnableRxOutput=false, EnableTxEn=false, EnableTxOutput=false, InterruptMode=2, InterruptTermEnable=true, IntrRxBreakDetected=false, IntrRxFrameErr=false, IntrRxFull=false, IntrRxNotEmpty=false, IntrRxOverflow=false, IntrRxParityErr=false, IntrRxTrigger=true, IntrRxUnderflow=false, IntrTxEmpty=false, IntrTxNotFull=false, IntrTxOverflow=false, IntrTxTrigger=false, IntrTxUartDone=false, IntrTxUartLostArb=false, IntrTxUartNack=false, IntrTxUnderflow=false, IrdaLowPower=false, IrdaPolarity=0, IsCtsPinAllowed=true, IsDmaCapable=true, IsEnableInputFilterVisible=true, IsMultiprocessorModeAvailable=false, IsRtsPinAllowed=true, IsRtsTriggerLevelVisible=false, IsRxIntrSourcesVisible=true, IsRxTriggerLevelVisible=true, IsTxIntrSourcesVisible=true, IsTxTriggerLevelVisible=false, MaxFifoLevel=127, MpRxAcceptAddress=false, MpRxAddress=0, MpRxAddressMask=255, OvsFactor=10, ParityType=0, PreconfigureIO=false, RemoveCtsPin=true, RemoveIntr=true, RemoveRtsPin=true, RemoveRxPin=false, RemoveRxTxPin=true, RemoveTxEnPin=true, RemoveTxPin=false, RtsPolarity=0, RtsTermEnable=false, RtsTriggerLevel=63, RxIntrMask=1, RxTermEnable=false, RxTriggerLevel=7, RxTxTermEnable=false, ShowTerminals=false, SmCardRetryOnNack=false, StopBits=2, SymbolShape=0, TriggerOutputEnable=false, TxEnTermEnable=false, TxIntrMask=0, TxTermEnable=false, TxTriggerLevel=63, UartMode=2, UseIntr=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SCB_UART_PDL_v2_0, CY_CONFIG_TITLE=ANALYZER_UART, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ANALYZER_UART, CY_INSTANCE_SHORT_NAME=ANALYZER_UART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=scb, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ANALYZER_UART, )
module SCB_UART_PDL_v2_0_5 (
    clock,
    cts_in,
    interrupt,
    rts_out,
...
// DMA_PDL_v2_0(BUFFERABLE=true, CHAIN_TO_1=0, CHAIN_TO_2=0, CHAIN_TO_3=0, CHAIN_TO_4=0, CHANNEL_PRIORITY=0, DATA_ELEMENT_SIZE_1=2, DATA_ELEMENT_SIZE_2=2, DATA_ELEMENT_SIZE_3=2, DATA_ELEMENT_SIZE_4=2, DESCR_NAME_1=Descriptor_1, DESCR_NAME_2=Descriptor_2, DESCR_NAME_3=Descriptor_3, DESCR_NAME_4=Descriptor_4, DESCRIPTORS_XML_STR=<?xml version="1.0" encoding="utf-16"?> <ArrayOfCyDmaDescriptionProperties xmlns:Version="ystem.Collections.Generic">   <CyDmaDescriptionProperties>     <DescriptorName>adcDmaDescriptor</DescriptorName>     <ChainToDescriptor>adcDmaDescriptor</ChainToDescriptor>     <SourceIncrementEveryCycleByX>0</SourceIncrementEveryCycleByX>     <DestinationIncrementEveryCycleByX>0</DestinationIncrementEveryCycleByX>     <SourceIncrementEveryCycleByY>0</SourceIncrementEveryCycleByY>     <DestinationIncrementEveryCycleByY>0</DestinationIncrementEveryCycleByY>   </CyDmaDescriptionProperties> </ArrayOfCyDmaDescriptionProperties>, DST_WIDTH_1=0, DST_WIDTH_2=0, DST_WIDTH_3=0, DST_WIDTH_4=0, INTR_OUT_1=0, INTR_OUT_2=0, INTR_OUT_3=0, INTR_OUT_4=0, MIGRATION=false, NUM_OF_DESCRIPTORS=1, PREEMPTABLE=true, SRC_WIDTH_1=0, SRC_WIDTH_2=0, SRC_WIDTH_3=0, SRC_WIDTH_4=0, TRIG_DEACT_1=0, TRIG_DEACT_2=0, TRIG_DEACT_3=0, TRIG_DEACT_4=0, TRIG_IN_TYPE_1=0, TRIG_IN_TYPE_2=0, TRIG_IN_TYPE_3=0, TRIG_IN_TYPE_4=0, TRIG_INPUT=true, TRIG_OUT_TYPE_1=0, TRIG_OUT_TYPE_2=0, TRIG_OUT_TYPE_3=0, TRIG_OUT_TYPE_4=0, TRIG_OUTPUT=false, X_DST_INCREMENT_1=1, X_DST_INCREMENT_2=1, X_DST_INCREMENT_3=1, X_DST_INCREMENT_4=1, X_NUM_OF_ELEMENTS_1=1, X_NUM_OF_ELEMENTS_2=1, X_NUM_OF_ELEMENTS_3=1, X_NUM_OF_ELEMENTS_4=1, X_SRC_INCREMENT_1=1, X_SRC_INCREMENT_2=1, X_SRC_INCREMENT_3=1, X_SRC_INCREMENT_4=1, Y_DST_INCREMENT_1=1, Y_DST_INCREMENT_2=1, Y_DST_INCREMENT_3=1, Y_DST_INCREMENT_4=1, Y_NUM_OF_ELEMENTS_1=1, Y_NUM_OF_ELEMENTS_2=1, Y_NUM_OF_ELEMENTS_3=1, Y_NUM_OF_ELEMENTS_4=1, Y_SRC_INCREMENT_1=1, Y_SRC_INCREMENT_2=1, Y_SRC_INCREMENT_3=1, Y_SRC_INCREMENT_4=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DMA_PDL_v2_0, CY_CONFIG_TITLE=ADC_DMA, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_DMA, CY_INSTANCE_SHORT_NAME=ADC_DMA, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=dma, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_DMA, )
module DMA_PDL_v2_0_6 (
    ...
    cy_mxs40_dw_v1_0 DW (
        ...
        .tr_in(tr_in),
        .tr_out(tr_out));
    defparam DW.priority = 0;



endmodule

// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=OP0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OP0, CY_INSTANCE_SHORT_NAME=OP0, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=OP0, )
module OpAmp_PDL_v1_0_7 (
    Vminus,
    Vout,
    Vplus);
    inout       Vminus;
    ...
    cy_mxs40_opamp_v1_0 cy_mxs40_opamp (
        .ctb_dsi_comp(Net_5),
        .out_10x(Net_14),
        .out_1x(Net_18),
        .vminus(Net_9),
        .vplus(Vplus));
    defparam cy_mxs40_opamp.deepsleep_available = 0;
    defparam cy_mxs40_opamp.has_resistor = 0;
    defparam cy_mxs40_opamp.needs_dsab = 0;
	...
	// cy_analog_virtualmux_2 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_2_connect(Vout, Net_14);
	defparam cy_analog_virtualmux_2_connect.sig_width = 1;
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=OP1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OP1, CY_INSTANCE_SHORT_NAME=OP1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=OP1, )
module OpAmp_PDL_v1_0_8 (
    Vminus,
    Vout,
    Vplus);
    inout       Vminus;
...
module top ;
    ...
    Scan_ADC_v3_10_0 ANALYZER_ADC (
        ...
        .t_dav(Net_35),
        .t_fvalid(Net_36),
        .t_fvinternal(Net_37[1:0]),
        .t_fvout(Net_38),
        .vagnd(Net_39),
        .vinPlus_0(Net_42));

	wire [0:0] tmpFB_0__INPUT_PIN_net;
	wire [0:0] tmpIO_0__INPUT_PIN_net;
	electrical [0:0] tmpSIOVREF__INPUT_PIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		INPUT_PIN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__INPUT_PIN_net[0:0]}),
		  .analog({Net_42}),
		  .io({tmpIO_0__INPUT_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__INPUT_PIN_net));
	...
	wire [0:0] tmpFB_0__OUTPUT_PIN_net;
	wire [0:0] tmpIO_0__OUTPUT_PIN_net;
	electrical [0:0] tmpSIOVREF__OUTPUT_PIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OUTPUT_PIN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUTPUT_PIN_net[0:0]}),
		  .analog({Net_106}),
		  .io({tmpIO_0__OUTPUT_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__OUTPUT_PIN_net));
    ...
    TCPWM_PWM_PDL_v1_0_1 ANALIZER_PWM (
        .clock(Net_223),
        .compare(Net_224),
        .count(1'b1),
        .interrupt(Net_226),
    ...
    VDAC12_PDL_v2_0_3 ANALYZER_VDAC (
        .clock(Net_105),
        .strobe(1'b0),
        .trigger(Net_222),
        .vout(Net_106),
    ...
    DMA_PDL_v2_0_4 VDAC_DMA (
        .interrupt(Net_312),
        .tr_in(Net_222),
        .tr_out(Net_313));

    SCB_UART_PDL_v2_0_5 ANALYZER_UART (
        .clock(Net_335),
        .cts_in(1'b0),
        .interrupt(Net_334),
        .rts_out(Net_338),
    ...
    OpAmp_PDL_v1_0_7 OP0 (
        .Vminus(Net_358),
        .Vout(Net_357),
        .Vplus(Net_356));

    OpAmp_PDL_v1_0_8 OP1 (
        .Vminus(Net_362),
        .Vout(Net_361),
        .Vplus(Net_360));

	wire [0:0] tmpFB_0__OP1_INP_net;
	wire [0:0] tmpIO_0__OP1_INP_net;
	electrical [0:0] tmpSIOVREF__OP1_INP_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP1_INP
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP1_INP_net[0:0]}),
		  .analog({Net_360}),
		  .io({tmpIO_0__OP1_INP_net[0:0]}),
		  .siovref(tmpSIOVREF__OP1_INP_net));


	wire [0:0] tmpFB_0__OP1_INN_net;
	wire [0:0] tmpIO_0__OP1_INN_net;
	electrical [0:0] tmpSIOVREF__OP1_INN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP1_INN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP1_INN_net[0:0]}),
		  .analog({Net_362}),
		  .io({tmpIO_0__OP1_INN_net[0:0]}),
		  .siovref(tmpSIOVREF__OP1_INN_net));


	wire [0:0] tmpFB_0__OP0_INP_net;
	wire [0:0] tmpIO_0__OP0_INP_net;
	electrical [0:0] tmpSIOVREF__OP0_INP_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP0_INP
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP0_INP_net[0:0]}),
		  .analog({Net_356}),
		  .io({tmpIO_0__OP0_INP_net[0:0]}),
		  .siovref(tmpSIOVREF__OP0_INP_net));


	wire [0:0] tmpFB_0__OP0_INN_net;
	wire [0:0] tmpIO_0__OP0_INN_net;
	electrical [0:0] tmpSIOVREF__OP0_INN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP0_INN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP0_INN_net[0:0]}),
		  .analog({Net_358}),
		  .io({tmpIO_0__OP0_INN_net[0:0]}),
		  .siovref(tmpSIOVREF__OP0_INN_net));


	wire [0:0] tmpFB_0__OP1_OUT_net;
	wire [0:0] tmpIO_0__OP1_OUT_net;
	electrical [0:0] tmpSIOVREF__OP1_OUT_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP1_OUT
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP1_OUT_net[0:0]}),
		  .analog({Net_361}),
		  .io({tmpIO_0__OP1_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__OP1_OUT_net));


	wire [0:0] tmpFB_0__OP0_OUT_net;
	wire [0:0] tmpIO_0__OP0_OUT_net;
	electrical [0:0] tmpSIOVREF__OP0_OUT_net;
	...
	cy_mxs40_gpio_v1_0
		...
		OP0_OUT
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP0_OUT_net[0:0]}),
		  .analog({Net_357}),
		  .io({tmpIO_0__OP0_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__OP0_OUT_net));
