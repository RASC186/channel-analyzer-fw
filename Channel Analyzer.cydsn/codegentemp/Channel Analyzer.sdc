...
# Project: C:\Users\Ramon\Desktop\git\channel-analyzer-fw\Channel Analyszer\Channel Analyzer.cydsn\Channel Analyzer.cyprj
# Date: Sun, 20 Aug 2023 00:35:56 GMT
#set_units -time ns
...
create_generated_clock -name {VDAC_CLK} -source [get_pins {ClockBlock/periclk}] -edges {1 101 201} [list [get_pins {ClockBlock/ff_div_47}]]
create_generated_clock -name {ADC_CLK} -source [get_pins {ClockBlock/periclk}] -edges {1 5 11} [list [get_pins {ClockBlock/ff_div_49}]]
create_generated_clock -name {PWM_CLK} -source [get_pins {ClockBlock/periclk}] -edges {1 5 11} [list [get_pins {ClockBlock/ff_div_11}]]
create_generated_clock -name {UART_CLK} -source [get_pins {ClockBlock/periclk}] -edges {1 5 11} [list [get_pins {ClockBlock/ff_div_5}]]
...
# Component constraints for C:\Users\Ramon\Desktop\git\channel-analyzer-fw\Channel Analyszer\Channel Analyzer.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\Ramon\Desktop\git\channel-analyzer-fw\Channel Analyszer\Channel Analyzer.cydsn\Channel Analyzer.cyprj
# Date: Sun, 20 Aug 2023 00:35:24 GMT
