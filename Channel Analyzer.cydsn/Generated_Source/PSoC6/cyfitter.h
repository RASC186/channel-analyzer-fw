...
/* OP0 */
#define OP0_cy_mxs40_opamp__HW CTBM0
#define OP0_cy_mxs40_opamp__IDX 0
#define OP0_cy_mxs40_opamp__OA_IDX 0u

/* OP1 */
#define OP1_cy_mxs40_opamp__HW CTBM0
#define OP1_cy_mxs40_opamp__IDX 1
#define OP1_cy_mxs40_opamp__OA_IDX 1u

/* ADC_CLK */
#define ADC_CLK__DIV_IDX 0
#define ADC_CLK__DIV_NUM 0
#define ADC_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* ADC_DMA */
#define ADC_DMA_DW__BLOCK_HW DW0
#define ADC_DMA_DW__BLOCK_NUMBER 0u
#define ADC_DMA_DW__CHANNEL_HW DW0_CH_STRUCT1
#define ADC_DMA_DW__CHANNEL_NUMBER 1u
#define ADC_DMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN1

/* PWM_CLK */
#define PWM_CLK__DIV_IDX 2
#define PWM_CLK__DIV_NUM 2
#define PWM_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* UART_CLK */
#define UART_CLK__DIV_IDX 1
#define UART_CLK__DIV_NUM 1
#define UART_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* VDAC_CLK */
#define VDAC_CLK__DIV_IDX 24
#define VDAC_CLK__DIV_NUM 0
#define VDAC_CLK__DIV_TYPE CY_SYSCLK_DIV_16_5_BIT

/* VDAC_DMA */
#define VDAC_DMA_DW__BLOCK_HW DW0
#define VDAC_DMA_DW__BLOCK_NUMBER 0u
#define VDAC_DMA_DW__CHANNEL_HW DW0_CH_STRUCT0
#define VDAC_DMA_DW__CHANNEL_NUMBER 0u
#define VDAC_DMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN0

/* ANALIZER_PWM */
#define ANALIZER_PWM_TCPWM__CNT_HW TCPWM0_CNT0
#define ANALIZER_PWM_TCPWM__CNT_IDX 0u
#define ANALIZER_PWM_TCPWM__HW TCPWM0
#define ANALIZER_PWM_TCPWM__IDX 0u

/* ANALYZER_ADC */
#define ANALYZER_ADC_SAR__HW SAR
#define ANALYZER_ADC_SAR__IDX 0
#define ANALYZER_ADC_SAR__TR_SAR_IN TRIG6_OUT_PASS_TR_SAR_IN
#define ANALYZER_ADC_SAR__TR_SAR_OUT TRIG14_IN_PASS_TR_SAR_OUT

/* ANALYZER_UART */
#define ANALYZER_UART_SCB__HW SCB5
#define ANALYZER_UART_SCB__IDX 5
#define ANALYZER_UART_SCB__SS0_POSITION 0u
#define ANALYZER_UART_SCB__SS1_POSITION 1u
#define ANALYZER_UART_SCB__SS2_POSITION 2u
#define ANALYZER_UART_SCB__SS3_POSITION 3u

/* ANALYZER_VDAC */
#define ANALYZER_VDAC_CTDAC__HW CTDAC0
#define ANALYZER_VDAC_CTDAC__IDX 0
#define ANALYZER_VDAC_CTDAC__TR_CTDAC_EMPTY TRIG14_IN_PASS_TR_CTDAC_EMPTY
...
#define CY_PROJECT_NAME "Channel Analyzer"
