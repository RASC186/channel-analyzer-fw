...
*
* Description:
*  This file provides constants and parameter values for the OP0
*  component.
*
* Note:
*  None.
...
/*******************************************************************************
                            Internal Constants
*******************************************************************************/
#define OP0_CTB_HW                         CTBM0
#define OP0_OPAMP_NUM                      ((OP0_cy_mxs40_opamp__OA_IDX == 0u) \
...
*******************************************************************************/
#define OP0_PARAM_Power                    (3UL)
#define OP0_PARAM_OutputDrive              (1UL)
#define OP0_PARAM_DeepSleep                (0UL)
...
*******************************************************************************/
    ...
    #define OP0_OPAMP_CHARGEPUMP           CY_CTB_PUMP_DISABLE
#else
    /* Charge pump configuration depends on Deep Sleep selection in the customizer. */
    #define OP0_OPAMP_CHARGEPUMP           CY_CTB_PUMP_ENABLE
#endif
/*******************************************************************************
                        Function Prototypes
*******************************************************************************/
void OP0_Start(void);
__STATIC_INLINE void OP0_Init(void);
__STATIC_INLINE void OP0_Enable(void);
__STATIC_INLINE void OP0_Stop(void);
__STATIC_INLINE void OP0_SetPower(cy_en_ctb_power_t power);
__STATIC_INLINE void OP0_SetDeepSleepMode(cy_en_ctb_deep_sleep_t deepSleep);

/*******************************************************************************
* Function Name: OP0_Init
****************************************************************************//**
*
...
*
* It is not necessary to call OP0_Init() because
* OP0_Start() calls this function. OP0_Start() is the
* preferred method to begin component operation.
*
*******************************************************************************/
__STATIC_INLINE void OP0_Init(void)
{
    (void) Cy_CTB_OpampInit(OP0_CTB_HW, OP0_OPAMP_NUM, &OP0_opampConfig);
}

/*******************************************************************************
* Function Name: OP0_Enable
****************************************************************************//**
*
* Turn on the CTB and set the opamp power level based on last call to
* OP0_SetPower(). If OP0_SetPower() was never called,
...
__STATIC_INLINE void OP0_Enable(void)
{
    Cy_CTB_Enable(OP0_CTB_HW);
    Cy_CTB_SetPower(OP0_CTB_HW, OP0_OPAMP_NUM, OP0_opampPower, OP0_OPAMP_CHARGEPUMP);
}

/*******************************************************************************
* Function Name: OP0_Stop
****************************************************************************//**
*
...
__STATIC_INLINE void OP0_Stop(void)
{
    Cy_CTB_SetPower(OP0_CTB_HW, OP0_OPAMP_NUM, CY_CTB_POWER_OFF, OP0_OPAMP_CHARGEPUMP);
}

/*******************************************************************************
* Function Name: OP0_SetPower
****************************************************************************//**
*
* Set the power level for the opamp.
*
* \param power
* - CY_CTB_POWER_OFF: This input option does nothing. OP0_Stop()
...
__STATIC_INLINE void OP0_SetPower(cy_en_ctb_power_t power)
{
    ...
    {
        Cy_CTB_SetPower(OP0_CTB_HW, OP0_OPAMP_NUM, power, OP0_OPAMP_CHARGEPUMP);

        /* Update the tracking variable for the opamp power level */
        OP0_opampPower = power;
    }
}

/*******************************************************************************
* Function Name: OP0_SetDeepSleepMode
****************************************************************************//**
*
...
*
* If OP0_Stop() is called before entering Deep Sleep mode,
...
__STATIC_INLINE void OP0_SetDeepSleepMode(cy_en_ctb_deep_sleep_t deepSleep)
{
    Cy_CTB_SetDeepSleepMode(OP0_CTB_HW, deepSleep);
}

#endif /* !defined(CY_OP0_H) */
